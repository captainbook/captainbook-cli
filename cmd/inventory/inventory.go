...
func Cmd() *cobra.Command {
	...
	cmd.AddCommand(makeResourceParent("pricing-categories", "Manage pricing categories (Adults, Children, ...)", pricingCategoriesDefs(), sharedRunner))
	cmd.AddCommand(makeResourceParent("pricing-tiers", "Manage pricing tiers", pricingTiersDefs(), sharedRunner))
	cmd.AddCommand(makeResourceParent("resources", "Manage resources (boats, guides, equipment)", resourcesDefs(), sharedRunner))
