...
- `skills/<resource>.md` — per-resource cookbooks with worked examples and resource-specific pitfalls. One per inventory resource family (auth, products, product-options, availabilities, pricing-categories, pricing-tiers, resources, locations, discounts, gift-certificates, bookings, transactions, customers, guests, extras, questions, answers, categories, media, notifications).
